...
//            acceptAlert(config.getTips());
            for (int i = 0; i < guideFlow.size(); i++) {
            	//System.out.println("guideFlow.size(): "+ guideFlow.size());
                try {
                    ...
                    if (actionType.equalsIgnoreCase(Action.SLIDE)) {
                    	...
                    	//System.out.println("guideFlow.get(i) " + guideFlow.get(i));
                        locationType = guideFlow.get(i).split(">>")[1].split(":")[1].split("/")[0];
              
                        //System.out.println("locationType: " + locationType);
                        if (actionType.equalsIgnoreCase(pers.traveler.constant.Action.CLICK)) {
                        	
                            location = guideFlow.get(i).split(">>")[1];
